        ...
        <div class="lg:px-12 md:py-36 pb-6 pt-72 px-6 relative rounded-3xl">
          ...
          >
            <div class="px-4 w-full md:w-8/12 xl:w-6/12">
              <h4
                class="font-bold font-serif mb-1 text-primary-600 dark:text-primary-300 uppercase"
              >
                Adopt A Plant
              </h4>
              <h1 class="capitalize leading-tight mb-2 text-white">
                Thousands of homeless plants, one act of kindness
              </h1>
              <p class="font-thin mb-6 text-gray-300">
                Find your new plant friend today! We have a wide variety of
                lovable plants available for adoption. Come visit us and take home
                your new best friend!
              </p>
              <BaseButton
                size="xl"
                label="Adopt A Plant Now"
                target="_blank"
                to="https://github.com/pinegrow/happy-paws-with-nuxt-tailwindcss"
              >
                <div class="inline-block ml-1 p-1.5 text-lg">Adopt A Plant Now!</div>
